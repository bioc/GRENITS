ReplicatesNet_student <- function(resultsFolder, timeSeries, numReps, ParamVec = NULL, chains = 2, user.seeds = NULL)
{
  ...
  for (i in 1:chains)
  {
    ...
    .Call("callStudent_Error", timeSeries, resultsFolder.i, ParamVec, PACKAGE = "GRENITS")
